module V1
  class KindsController < ApplicationController
    ...
    # http_basic_authenticate_with name: "maycon", password: "secret"

    # include ActionController::HttpAuthentication::Digest::ControllerMethods
    # USERS = { "maycon" => Digest::MD5.hexdigest(["maycon","Application","secret"].join(":"))}
    ...
    private
      ...
      #     JWT.decode token, hmac_secret, true, { :algotithm => 'HS256' }
